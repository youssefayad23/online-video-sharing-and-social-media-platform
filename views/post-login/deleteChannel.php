...
if (isset($_POST['submit'])) {
    ...
    if ($password == $userPassword) {
        ...
        echo "<script>alert('Channel Delete Completed. :( ')</script>";
    } else {
        header('location: deleteChannel.php');
        echo "<script>alert('Channel Delete NOT Completed. :) ')</script>";
    }
}
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link" href="deleteChannel.php">Delete Channel <span class="sr-only">(current)</span></a>
                                </li>
                    ...
                    <form method="POST" action="">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control border-form-control" required name="password" value="" placeholder="password" type="password">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-left">
                                <button type="submit" name="submit" class="btn btn-success border-none"> Delete Channel </button>
                            </div>
                        </div>
                    </form>
                </div>
