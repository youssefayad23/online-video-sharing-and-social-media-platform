                        ...
                        $playlistIndex = $_SESSION['playlistID']; {
                           if (!isset($q)) {
                            ...
                            DESC");
                              ...
                              displayPlaylistAddVideos($query, $playlistIndex, $con);
                           } else {
...
<?php
      ...
      $playlistIndex = $_SESSION['playlistID'];
      $playlist->addVideo($playlistIndex, $_GET['videoIndex'], $con);
      header("location: add-vid.php?playlistIndex='.$playlistIndex.'");
   }
}
?>